...
def transform_items(data, config) -> dict:
    ...
    # remove all lines where the documentNumber starts not with ER*
    transformed_items = [item for item in transformed_items if item.get("documentNumber", "").startswith("ER")]
